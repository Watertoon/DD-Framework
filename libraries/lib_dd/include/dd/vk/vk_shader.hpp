        ...
        public:
            ...
            void Initialize(const Context *context, const ShaderInfo *shader_info) {
                ...
                if (shader_info->compute_code != nullptr) {
                    ...
                    const u32 result = ::pfn_vkCreateShaderModule(context->GetDevice(), std::addressof(shader_module_info), nullptr, std::addressof(vk_compute_module));
                    DD_ASSERT(result == VK_SUCCESS);
            ...
            constexpr ALWAYS_INLINE bool IsCompute() const { return false; }
    };
}

    ...
    class DepthStencilTargetView {
        ...
        public:
            ...
            void Initialize(const Context *context, const DepthStencilTargetInfo *target_info) {
                ...
                const u32 result0 = ::pfn_vkCreateImageView(context->GetDevice(), std::addressof(view_info), nullptr, std::addressof(m_vk_depth_stencil_image_view));
            ...
            void Finalize(const Context *context) {
                ::pfn_vkDestroyImageView(context->GetDevice(), m_vk_depth_stencil_image_view, nullptr);

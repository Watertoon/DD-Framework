...
# Compiler options
COMPILER_FLAGS := -msse4.1 -fno-rounding-math -fno-signaling-nans -ffunction-sections -fdata-sections -fno-strict-aliasing -fwrapv -fno-asynchronous-unwind-tables -fno-unwind-tables -fno-stack-protector -fno-rtti -fno-exceptions -std=gnu++20 -m64

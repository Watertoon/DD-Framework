...
DEFINE_GL_PROC(PFNWGLSWAPINTERVALEXTPROC,         wglSwapIntervalEXT);
...
DEFINE_GL_PROC(PFNGLGETSHADERINFOLOGPROC,  glGetShaderInfoLog);
...
DEFINE_GL_PROC(PFNGLPROGRAMUNIFORMMATRIX2FVPROC,    glProgramUniformMatrix2fv);
DEFINE_GL_PROC(PFNGLPROGRAMUNIFORMMATRIX3FVPROC,    glProgramUniformMatrix3fv);
DEFINE_GL_PROC(PFNGLPROGRAMUNIFORMMATRIX3X4FVPROC,  glProgramUniformMatrix3x4fv);
DEFINE_GL_PROC(PFNGLPROGRAMUNIFORMMATRIX4X3FVPROC,  glProgramUniformMatrix4x3fv);
DEFINE_GL_PROC(PFNGLPROGRAMUNIFORMMATRIX4FVPROC,    glProgramUniformMatrix4fv);
DEFINE_GL_PROC(PFNGLPROGRAMUNIFORMMATRIX2DVPROC,    glProgramUniformMatrix2dv);
DEFINE_GL_PROC(PFNGLPROGRAMUNIFORMMATRIX3DVPROC,    glProgramUniformMatrix3dv);
DEFINE_GL_PROC(PFNGLPROGRAMUNIFORMMATRIX3X4DVPROC,  glProgramUniformMatrix3x4dv);
DEFINE_GL_PROC(PFNGLPROGRAMUNIFORMMATRIX4X3DVPROC,  glProgramUniformMatrix4x3dv);
DEFINE_GL_PROC(PFNGLPROGRAMUNIFORMMATRIX4DVPROC,    glProgramUniformMatrix4dv);
...
void LoadGLProcs() {
    ...
    LOAD_GL_PROC(PFNWGLSWAPINTERVALEXTPROC,         wglSwapIntervalEXT);
    ...
    LOAD_GL_PROC(PFNGLPROGRAMUNIFORMMATRIX2FVPROC,    glProgramUniformMatrix2fv);
    LOAD_GL_PROC(PFNGLPROGRAMUNIFORMMATRIX3FVPROC,    glProgramUniformMatrix3fv);
    LOAD_GL_PROC(PFNGLPROGRAMUNIFORMMATRIX3X4FVPROC,  glProgramUniformMatrix3x4fv);
    LOAD_GL_PROC(PFNGLPROGRAMUNIFORMMATRIX4X3FVPROC,  glProgramUniformMatrix4x3fv);
    LOAD_GL_PROC(PFNGLPROGRAMUNIFORMMATRIX4FVPROC,    glProgramUniformMatrix4fv);
    LOAD_GL_PROC(PFNGLPROGRAMUNIFORMMATRIX2DVPROC,    glProgramUniformMatrix2dv);
    LOAD_GL_PROC(PFNGLPROGRAMUNIFORMMATRIX3DVPROC,    glProgramUniformMatrix3dv);
    LOAD_GL_PROC(PFNGLPROGRAMUNIFORMMATRIX3X4DVPROC,  glProgramUniformMatrix3x4dv);
    LOAD_GL_PROC(PFNGLPROGRAMUNIFORMMATRIX4X3DVPROC,  glProgramUniformMatrix4x3dv);
    LOAD_GL_PROC(PFNGLPROGRAMUNIFORMMATRIX4DVPROC,    glProgramUniformMatrix4dv);
